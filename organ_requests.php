...
<?php
                        ...
                        if (isset($_POST['submit'])) {
                          ...
                          $stmt = $con->prepare("INSERT INTO organ_requests (REGISTRATION_ID, ORGAN_TYPE, BLOOD_GROUPn, REQUEST_TYPE, ADD_RESSn, ZIP_CODE, phoneN) 
                          VALUES (?, ?, ?, ?, ?, ?, ?)");
                          ...
                          $stmt->bind_param("issssis", $id, $ORGAN_TYPE,  $BLOOD_GROUPn, $REQUEST_TYPE, $ADD_RESSn, $ZIP_CODE, $PhoneN);
                      
                          if ($stmt->execute()) {
                              echo "<h4 style='color:green;'>Your request has been added successfully.</h4>";
                          } else {

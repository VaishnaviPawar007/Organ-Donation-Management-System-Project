            ...
            <section class="row jumbotron justify-content-center">
                <section class="col-l4 col-sm-6">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $con = new mysqli('localhost', 'root', 'Vish@7130', 'organdb');
                        $stmt = $con->prepare("INSERT INTO donation_record(REGISTRATION_ID,ORGAN_TYPEd,BLOOD_GROUPd,short_note)
                            values(?,?,?,?)");
                        $stmt->bind_param("isss", $id,$organ_typeD,$bloodgroupD,$short_note);
                        $stmt->execute();
